...
const content = {
  ...
  intro: {
    ...
    body: "I spent years building government AI systems from the inside \u2014 including Germany\u2019s first BITV-certified government app, scaled to over a million users. I watched technically excellent systems fail in the field because no one had designed the human layer. Trust by Design is the framework I built because it didn\u2019t exist."
  },
  expertise: {
    heading: "What I bring",
    e1: { title: "Government Digital Services", body: "10+ years building citizen-facing digital services in the German public sector, including high-stakes identity and compliance systems." },
    e2: { title: "EU AI Act Compliance", body: "Specialist in human-centred compliance for high-risk AI systems ahead of August 2026 enforcement." },
    e3: { title: "Accessibility & BITV", body: "Led Germany\u2019s first BITV-certified government app. Accessibility isn\u2019t a checkbox \u2014 it\u2019s the foundation of trustworthy design." },
    e4: { title: "Independent Research", body: "Master\u2019s in Design for Responsible AI, ELISAVA. Framework developed across 14+ AI implementation teams in the German public sector." }
  },
  approach: {
    heading: "How I work",
    body: "I work as a trusted partner to regulated organisations \u2014 embedded enough to understand your systems, independent enough to see what your team can\u2019t. I don\u2019t deliver reports and disappear. I work alongside product, UX, compliance, and leadership teams to build the Trust Layer into what you\u2019re already building."
  },
  credibility: {
    strip: "i-Kfz digital driver\u2019s licence \u00B7 1M+ downloads \u00B7 6+ German government communities \u00B7 BITV certified \u00B7 ELISAVA Master\u2019s research \u00B7 Global Digital Transformation Summit speaker"
  },
  cta: {
